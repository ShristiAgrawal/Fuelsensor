...
public class BankDonorsListAdapter extends RecyclerView.Adapter <BankDonorsListAdapter.MyViewHolder>{
    ArrayList<UserModel> userModels;
    Context context;
    SharedPreferences preferences;

    public BankDonorsListAdapter(ArrayList<UserModel> userModels, Context context) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.notify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               NotifyUser(All_urls.values.NotifyByUser,userModels.get(position).getPhone(),preferences.getString("BankName",""));
            }
        });
